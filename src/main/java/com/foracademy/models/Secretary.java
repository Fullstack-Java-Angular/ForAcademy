...
public class Secretary extends User {
    ...
    public Secretary(int id, String lastName, String firstName, String email, String password, String phone, String gander, Date dateOfBirth, boolean active, Address address, Role role, Date dateOfEntryToFactory) {
